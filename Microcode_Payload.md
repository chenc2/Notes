...
|Section|Type|Size|
|:----:|:------------------:|:------:|
|Header|CPU_MICROCODE_HEADER|48 bytes|
|Binary|Microcode Binary|2000 bytes or indicated by DataSize|
|Extended Table Header|CPU_MICROCODE_EXTENDED_TABLE_HEADER|20 bytes|
|Extended Table|CPU_MICROCODE_EXTENDED_TABLE|12 bytes|

## CheckSum
- **One CheckSum for Header + Binary**
- **One CheckSum for Extended Table Header + Extended Table**
- **Both CheckSum must be equals to zero, otherwise it's an invalid data**

## CPU_MICROCODE_HEADER
- **HeaderVersion: Should be 1 for valid data, otherwise walk to next 1KB offset**
- **DataSize: Size of the binary part, If the value is 0, the size of binary is 2000 bytes**
- **TotalSize: Total size of Header, Binary, Extended Table Header and Extended Table**
``` C
///
